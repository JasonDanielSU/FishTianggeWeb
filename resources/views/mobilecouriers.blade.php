@extends('layouts.mobilecourierlayout')
...
<h4 class="modal-title" id="mobilecourierCrudModal"></h4>
</div>
<div class="modal-body">
<form name="mobilecourierForm" action="{{ route('mobilecouriers.store') }}" method="POST">
<input type="hidden" name="mobilecourier_id" id="mobilecourier_id" >
@csrf
<div class="row">
...
<select name="status" id="status" class="form-control">
  <option value="Accepted" onchange="validate()" >Accept mobilecourier</option>
</select>
</div>
</div>
...
<a href="{{ route('mobilecouriers.index') }}" class="btn btn-danger">Cancel</a>
</div>
</div>
</form>
</div>
...
<!-- Show mobilecourier modal -->
<div class="modal fade" id="crud-modal-show" aria-hidden="true" >
<div class="modal-dialog">
<div class="modal-content">
<div class="modal-header">
<h4 class="modal-title" id="mobilecourierCrudModal-show"></h4>
</div>
<div class="modal-body">
<div class="row">
...
<tr><td></td><td style="text-align: right "><a href="{{ route('mobilecouriers.index') }}" class="btn btn-danger">OK</a> </td></tr>
</table>
</div>
</div>
</div>
